...
release:
	...
	docker-compose -f docker/release/docker-compose.yml run --rm app managy.py collectstatic --noinput
	docker-compose -f docker/release/docker-compose.yml run --rm app managy.py migrate --noinput
